...
function ready() {
    let overlays = Array.from(document.getElementsByClassName('overlay-text'));// Turn html elements to array
    let cards = Array.from(document.getElementsByClassName('card'));// Turn html elements to array
    let game = new MixOrMatch(100, cards);

    // Adding an EventListener for each element
